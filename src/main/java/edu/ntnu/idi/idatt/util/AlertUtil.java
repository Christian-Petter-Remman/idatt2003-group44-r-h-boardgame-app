...
public class AlertUtil {
   ...
   * <h2>showAlert</h2>
   *
   * <p>Displays a modal error alert dialog with the specified title and message. The alert is
   * attached
   * to the currently active main window if available.
   *
   ...
   *
   * <p>Searches for the first visible window in the JavaFX application.
   *
