 ...
 * Utility class responsible for generating unique, timestamped filenames
 * for saving game state files for both Snakes and Ladders and StarGame.
 */
public class SaveFileNameGenerator {

  /**
   * <h2>formatter</h2>
   * Formatter used to convert the current date and time into a filename-friendly format.
