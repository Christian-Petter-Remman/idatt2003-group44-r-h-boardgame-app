 ...
 * <h1>StarIntroView</h1>
 *
 * <p>This class represents the introduction screen for the Star game. It provides buttons for
 * starting
...
public class StarIntroView implements IntroView {
   ...
   * <h2>Constructor</h2>
   *
   * <p>Initializes an empty instance. The UI is not built until {@code initializeUI()} is called.
   */
   ...
   * <h2>initializeUI</h2>
   *
   * <p>Triggers creation of the view's layout and graphical elements.
   */
   ...
   * <h2>createUI</h2>
   *
   * <p>Constructs the main layout for the intro screen, sets background, and adds game selection
   * buttons.
   */
  protected void createUI() {
    ...
    BackgroundImage bgImage = new BackgroundImage(
        new Image(Objects.requireNonNull(getClass().getResource("/home_screen/stargame1.png"))
            .toExternalForm(),
            0, 0, true, true),
   ...
   *
   * <p>Builds the vertical layout box containing "New Game" and "Load Game" buttons with action
   * listeners.
   *
   ...
   *
   * <p>Applies visual styles and hover behavior to game option buttons.
   *
   ...
   *
   * <p>Assigns a listener that will be triggered when the user clicks "New Game".
   *
   ...
   *
   * <p>Assigns a listener that will be triggered when the user clicks "Load Game".
   *
