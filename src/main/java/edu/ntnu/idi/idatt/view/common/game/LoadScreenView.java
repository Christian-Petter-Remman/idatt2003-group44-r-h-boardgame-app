...
import static edu.ntnu.idi.idatt.controller.snl.SNLLoadController.getLastNPlayerFiles;

public class LoadScreenView extends AbstractView {

  private final SNLLoadController controller;

  private Button backButton;

  public LoadScreenView(SNLLoadController controller) {
