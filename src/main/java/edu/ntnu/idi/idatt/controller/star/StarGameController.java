 ...
 * Controller class for managing the StarGame logic and navigation.
 * It acts as a bridge between the game model, the observers, and the navigation system.
 */
public class StarGameController implements NavigationHandler {
  ...
  public String getTileColor(int tileNum) {
    ...
    if (tile.hasAttribute(Bridge.class)) return "yellow";
    if (tile.hasAttribute(Tunnel.class)) return "purple";
    if (tile.hasAttribute(Path.class)) return "blue";
    if (tileNum == 1000) return "black";
