 ...
 * <h1>StarFactory</h1>
 *
 * <p>Factory class responsible for loading {@link StarBoard} instances from JSON files using the
 * {@link StarBoardJsonHandler}.
 */
public class StarFactory {
   ...
   *
   * <p>Loads a Star board from a specified JSON file name.
   *
   * @param fileName The name of the JSON file located in the star game board directory.
   * @return A {@link StarBoard} object if loading succeeds, or {@code null} if the file doesn't
