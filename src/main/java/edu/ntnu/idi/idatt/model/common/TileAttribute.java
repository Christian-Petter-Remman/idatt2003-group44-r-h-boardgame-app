 ...
 * <h1>TileAttribute</h1>
 *
 * <p>Represents a behavior or effect that can be associated with a tile on the game board.
...
public interface TileAttribute {
   ...
   * <h2>onLand</h2>
   *
   * <p>Triggered when a player lands on a tile containing this attribute.
   *
