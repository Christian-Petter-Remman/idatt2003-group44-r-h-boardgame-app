 ...
 *
 * Interface for observing when a player must make a directional decision
 * on a path tile in the game. Typically used in games with branching tile options
 * such as StarGame.
 */
public interface PathDecisionObserver {
   ...
   *
   * Called when a player lands on a path tile and must choose a direction.
   *
