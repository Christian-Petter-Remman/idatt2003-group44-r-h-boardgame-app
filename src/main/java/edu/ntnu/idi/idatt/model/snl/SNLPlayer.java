 ...
 * <h1>SNLPlayer</h1>
 *
 * <p>Represents a player specific to the Snakes and Ladders game. Inherits common properties from
 * {@link Player}.
 */
public class SNLPlayer extends Player {
   ...
   * <h2>Constructor</h2>
   *
   * <p>Initializes a new SNL player.
   *
   ...
   * <h2>hasWon</h2>
   *
   * <p>Determines whether the player has reached or passed tile 100.
   *
   ...
   *
   * <p>Returns the starting position for this player.
   *
